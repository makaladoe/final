...
const VideoCard: React.FC<VideoCardProps> = ({ url, autoplay = false, style = {} }) => {
  ...
  const controlsOpacity = useRef(new Animated.Value(autoplay ? 1 : 0)).current;
    ...
    >
      ...
      {showControls && (
        <Animated.View
          ...
          style={[StyleSheet.absoluteFill, { opacity: controlsOpacity, justifyContent: 'center', alignItems: 'center' }]}
        >
