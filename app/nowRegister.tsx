...
const Register: React.FC = () => {
  ...
  return (
    <ImageBackground
      ...
      resizeMode="cover"
    >
      {/* MATCHED OVERLAY TO SECOND SCREEN */}
      <View style={styles.overlay}>
        <SafeAreaView style={styles.container}>
          {/* ------------------ TOP HEADER ------------------ */}
          <View style={styles.headerBox}>
            <Text style={styles.registeringText}>You are registering:</Text>
          ...
          >
            ...
            >
              <Text style={styles.sectionHeaderSmall}>Other Licensed Registrars</Text>
          ...
          <Modal visible={!!selectedUrl} animationType="slide">
            <SafeAreaView style={{ flex: 1 }}>
              <TouchableOpacity style={styles.closeButton} onPress={() => setSelectedUrl(null)}>
...
const styles = StyleSheet.create({
  ...
  // MATCHED EXACTLY TO THE OTHER SCREEN
  overlay: {
    flex: 1,
    backgroundColor: "rgba(0,0,0,0.25)", // same overlay as your other screen
  },
  ...
  sectionHeader: {
    ...
    marginTop: 28,
    marginBottom: 16,
    color: "#fff", // white text to match contrast
  },
