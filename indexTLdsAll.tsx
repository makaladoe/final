...
export default function HomeScreen() {
  ...
  // 🔥 UPDATED — Profile loading placeholder control
  ...
  // 🔥 UPDATED — handle profile loading properly
  useEffect(() => {
  ...
  // 🔥 UPDATED — initials now show "..." instead of "U" when loading
...
// ----------------------
// ACTIONS ARRAY — TYPE SAFE
// ----------------------
const actions: {
  title: string;
  subtitle: string;
  route: AppRoute; // ✅ Ensures only allowed routes
  color: string;
  ...
  },
  {
    ...
    route: "/delete",
    color: "#e53935",
    icon: <MaterialIcons name="delete-forever" size={40} color="#fff" />,
  },
];
